...
public class AttendanceRecord {
    ...
    public void checkOut(Instant at){checkOut(at,null,null,null,null);} public void checkOut(Instant at,Double latitude,Double longitude,Double accuracy,Double distance){this.checkOutAt=at;this.checkOutLatitude=latitude;this.checkOutLongitude=longitude;this.checkOutAccuracyMeters=accuracy;this.checkOutDistanceMeters=distance;this.status=Status.COMPLETED;} public void adjust(Instant checkInAt,Instant checkOutAt){if(checkInAt!=null)this.checkInAt=checkInAt;if(checkOutAt!=null){this.checkOutAt=checkOutAt;this.status=Status.COMPLETED;}}
    public UUID getId(){return id;} public UUID getOrganizationId(){return organizationId;} public UUID getEmployeeId(){return employeeId;} public UUID getShiftId(){return shiftId;} public LocalDate getWorkDate(){return workDate;} public String getShiftName(){return shiftName;} public Instant getScheduledStartAt(){return scheduledStartAt;} public Instant getScheduledEndAt(){return scheduledEndAt;} public Instant getCheckInAt(){return checkInAt;} public Instant getCheckOutAt(){return checkOutAt;} public int getBreakMinutes(){return breakMinutes;} public Status getStatus(){return status;} public Double getCheckInLatitude(){return checkInLatitude;} public Double getCheckInLongitude(){return checkInLongitude;} public Double getCheckInAccuracyMeters(){return checkInAccuracyMeters;} public Double getCheckInDistanceMeters(){return checkInDistanceMeters;} public Double getCheckOutLatitude(){return checkOutLatitude;} public Double getCheckOutLongitude(){return checkOutLongitude;} public Double getCheckOutAccuracyMeters(){return checkOutAccuracyMeters;} public Double getCheckOutDistanceMeters(){return checkOutDistanceMeters;} public String getWorkMode(){return workMode;} public boolean isQrVerified(){return qrVerified;}
}
