...
create index salary_regulations_org_status_idx on salary_regulations(organization_id, status, effective_date desc);
create index salary_regulations_org_type_idx on salary_regulations(organization_id, salary_type);
