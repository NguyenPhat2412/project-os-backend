...
public class UserAccount {
    ...
    @Column(name = "delete_expires_at") private Instant deleteExpiresAt;
    ...
    public Instant getDeleteExpiresAt() { return deleteExpiresAt; }
    ...
    public void updateAdminFields(String email, String displayName, String avatarUrl, Role role, Status status) {
        ...
        if (status != Status.DELETED) {
            this.deletedAt = null;
            this.deleteExpiresAt = null;
        }
    }
    public void moveToRecycleBin(Instant deletedAt) {
        this.status = Status.DELETED;
        this.deletedAt = deletedAt;
        this.deleteExpiresAt = deletedAt.plus(30, ChronoUnit.DAYS);
    }
