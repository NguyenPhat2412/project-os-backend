# Historical: ProjectOS Deployment Worklog - 2026-07-10

> This worklog is historical deployment context. Current operations guidance is in `../../../docs/operations/`.
...
- At the time of this worklog, the frontend still used Firebase/Next API routes; this statement is not current architecture guidance.
